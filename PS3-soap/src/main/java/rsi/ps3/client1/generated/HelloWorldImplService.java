 ...
 * 
 */
@WebServiceClient(name = "HelloWorldImplService", targetNamespace = "http://server.ps3.rsi/", wsdlLocation = "http://192.168.0.113:9999/HelloWorld?wsdl")
    ...
    extends Service
{
    ...
    private final static QName HELLOWORLDIMPLSERVICE_QNAME = new QName("http://server.ps3.rsi/", "HelloWorldImplService");

    static {
        URL url = null;
        WebServiceException e = null;
        try {
            url = new URL("http://192.168.0.113:9999/HelloWorld?wsdl");
    ...
    public HelloWorld getHelloWorldImplPort() {
        return super.getPort(new QName("http://server.ps3.rsi/", "HelloWorldImplPort"), HelloWorld.class);
    }
    ...
    public HelloWorld getHelloWorldImplPort(WebServiceFeature... features) {
        return super.getPort(new QName("http://server.ps3.rsi/", "HelloWorldImplPort"), HelloWorld.class, features);
    }

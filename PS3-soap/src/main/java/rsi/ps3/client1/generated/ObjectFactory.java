...
package rsi.ps3.client1.generated;
 ...
 * generated in the rsi.ps3.client1.generated package. 
...
public class ObjectFactory {
    ...
    private final static QName _GetHelloWorldAsStringResponse_QNAME = new QName("http://server.ps3.rsi/", "getHelloWorldAsStringResponse");
    private final static QName _GetHelloWorldAsString_QNAME = new QName("http://server.ps3.rsi/", "getHelloWorldAsString");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: rsi.ps3.client1.generated
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ps3.rsi/", name = "getHelloWorldAsStringResponse")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ps3.rsi/", name = "getHelloWorldAsString")

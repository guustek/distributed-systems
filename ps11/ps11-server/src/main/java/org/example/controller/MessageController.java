...
public class MessageController {
    ...
    // ps11 - zad2 zaczynasie
    @GetMapping(value = "/message-prefix", produces = MediaType.APPLICATION_JSON_VALUE)
    public List<Message> getMessageStartsWithPrefix(@RequestParam String prefix) {
        return messageService.getAllMessagesStartWithPrefix(prefix);
    }

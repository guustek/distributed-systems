 ...
 * generated in the rsi.ps5.client.generated.authservice package. 
...
public class ObjectFactory {
    ...
    private final static QName _Authenticate_QNAME = new QName("http://server.ps5.rsi/", "authenticate");
    private final static QName _AuthenticateResponse_QNAME = new QName("http://server.ps5.rsi/", "authenticateResponse");

    /**
     * Create a new ObjectFactory that can be used to create new instances of schema derived classes for package: rsi.ps5.client.generated.authservice
     * 
     */
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ps5.rsi/", name = "authenticate")
     ...
     * 
     */
    @XmlElementDecl(namespace = "http://server.ps5.rsi/", name = "authenticateResponse")
